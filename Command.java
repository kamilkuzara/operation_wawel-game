 ...
 * word, and a third word (for example, if the command was "attack enemy gun",
 * then the three strings obviously are "attack", "enemy" and "gun").
 * 
 * The way this is used is: Commands are already checked for being valid
 * command words. If the user entered an invalid command (a word that is not
 * known) then the command word is <null>.
 *
 * If the command had only one word, then the second and third word is <null>.
 * 
